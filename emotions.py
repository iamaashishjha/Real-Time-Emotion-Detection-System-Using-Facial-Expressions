...
def plot_model_history(model_history):
    ...
    axs[0].set_xticks(
        ...
        np.arange(0,len(model_history.history["accuracy"]),step=len(model_history.history["accuracy"]) / 10),
    )
    ...
    axs[1].set_xticks(
        ...
        np.arange(0,len(model_history.history["loss"]),step=len(model_history.history["loss"]) / 10),
    )
